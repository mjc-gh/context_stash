...
- Write semantic commit messages following project conventions
- Push commits to the main branch

## When to use me
Use this skill when you need to commit your work and push it to the main branch with a proper semantic commit message.
